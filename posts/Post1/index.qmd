...
The dataset I'm working with is from kaggle called DEV _ MarchMadness.csv. You can find it here: [Kaggle March Madness Dataset](https://www.kaggle.com/datasets/jonathanpilafas/2024-march-madness-statistical-analysis). It contains metrics for 8315 NCAA teams from 2002-2025. To answer my question, I needed to come up with some parameters for what is considered a Cinderella team. I decided to have only 9 or above seeds in the tournament, and you had to make the final four. Originally I wanted to do elite 8 to allow for more teams to meet the criteria, but this dataset didn't have that. I would love to explore that further in the future. 
...
Opponent 3pt%: Cinderella teams seem to hold their opponents to a much lower percentage from 3. Just like offensively, 3pt shooting seems to be a key difference maker. If you lose the 3pt battle you're going to find yourself in a hole. 
